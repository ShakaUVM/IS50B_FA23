...
void eggert(bool enabled) {
    ...
    // Draw Origin
    DrawCircle(size, 0.0f, 2.0f, PINK);
    ...
    DrawCube(westWall_orig, wallThickness, wallHeight, size, DARKGRAY);
    DrawCube(eastWall_orig, wallThickness, wallHeight, size, DARKGRAY);
